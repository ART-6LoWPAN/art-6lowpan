 ...
 * 2017-08-25    armink       add more SPI port
 */
...
#define RT_USING_SPI2_PB12_PB13_PB14_PB15        1
...
static int rt_hw_spi_init(void)
{
...
#ifdef RT_USING_SPI2
#if RT_USING_SPI2_PB12_PB13_PB14_PB15
    /* register spi bus */
    {
        static struct stm32_spi_bus stm32_spi;
        GPIO_InitTypeDef GPIO_InitStructure;
    ...
    /* register spi bus */
    {
        ...
        GPIO_PinAFConfig(GPIOC, GPIO_PinSource2, GPIO_AF_SPI1);
